...
const LandingPagev2_EmailWarmup = () => {
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-start justify-start w-auto md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 gap-40 items-center justify-center max-w-[1440px] md:px-10 sm:px-5 px-[140px] py-[60px] w-full">
                        <div className="flex flex-col md:gap-10 gap-[60px] h-[360px] md:h-auto items-start justify-start">
                            ...
                            <div className="flex flex-col gap-4 items-center justify-start w-[570px] sm:w-full">
                                <div className="flex sm:flex-col flex-row gap-3 items-center justify-start w-full">
                                    <input
                                        id="warmup_input"
                                        name="fieldbox"
                                        placeholder="Enter your email"
                                        className={`font-lato text-left text-xs w-full p-0 placeholder:text-gray-600 ${error ? 'border-red-500' : 'border-gray-200'} border border-solid flex-1 sm:flex-1 w-[76%] sm:w-full`}
                                        type="email"
                                    ...
                                    <button
                                        id="warmup_button"
                                        className="cursor-pointer flex h-12 items-center justify-center rounded-full px-2.5 "
                                        onClick={handleNext}


                                        style={{ width: "150px", background: "#F0C419", color: "white" }}
                                    >
                                        <div className="flex items-center justify-center w-full">
                                            <span className="font-poppins font-semibold text-center text-xs text-white">
                                                Warm up
                                            </span>
                                            <img
                                                loading="lazy"
                                ...
                                {error && (<div className="text-start w-full ml-3"><p className="text-red-400">Please enter email address</p></div>)}
                                ...
                                >
                                    ...
                                    <div className="self-center h-11 bg-black-900_19 w-px" ></div>
                                    <div className="flex flex-1 md:flex-1 flex-col gap-2.5 items-center justify-start w-auto md:w-full">
                                        <div className="flex flex-row gap-1 items-end justify-end w-auto">
                                            <img
                                                loading="lazy"
              ...
              /> */}
                            ...
                            {/*   <img
                loading="lazy" src="/images/hero-section-img.png" /> */}
                            <img
                                loading="lazy"
                                src="/images/Hero_animation/Hero-New-Animation-2.gif"
                            />
                ...
                {!isToggled && (
                  <div>
                    {state1 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-1.png" />
                    )}
                    {state2 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-2.png" />
                    )}
                    {state3 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-3.png" />
                    )}
                    {state4 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-4.png" />
                    )}
                    {state5 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-5.png" />
                    )}
                    {state6 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-6.png" />
                    )}
                    {state7 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-off-7.png" />
                    )}
                  </div>
                )}
                {isToggled && (
                  <div>
                    {state1 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-1.png" />
                    )}
                    {state2 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-2.png" />
                    )}
                    {state3 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-3.png" />
                    )}
                    {state4 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-4.png" />
                    )}
                    {state5 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-5.png" />
                    )}
                    {state6 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-6.png" />
                    )}
                    {state7 && (
                        <img
                loading="lazy" src="/images/Hero_animation/warmup-on-7.png" />
                    )}
                  </div>
                )}
              </div> */}
              ...
              /> */}
                            <div className="absolute bg-[#f5eef0] h-[360px] inset-y-[0] my-auto object-cover right-[0] w-[430px]"></div>
                            <img
                                loading="lazy"
                    ...
                    {/* <div className="flex md:flex-col flex-row font-dmsans md:gap-10 gap-40 items-center justify-end max-w-[1440px] md:px-10 sm:px-5 px-[200px] py-[60px] w-full">
            <div
              className="bg-cover bg-no-repeat flex md:flex-1 flex-col h-[360px] items-center justify-center p-[9px] md:px-5 w-[42%] md:w-full"
              // style={{
              //   backgroundImage: "url('images2/img_frame1000003149.png')",
              // }}
            >
            ...
            <div className="flex flex-1 flex-col items-start justify-start w-full">
              <div className="flex flex-col gap-3 items-start justify-center w-full">
                ...
                >
                  ...
                  Bad Reputation doesn’t just get bad delivery but bad ranking
                  on Google. Don’t Let it happen to you.
                </p>
              </div>
            </div>
          </div> */}
                    ...
                    <div className="flex flex-col font-dmserifdisplay md:gap-10 gap-[60px] items-center justify-center max-w-[1440px] md:px-10 sm:px-5 px-[140px] py-20 w-full">
                        ...
                        >
                            {/* <div className="border border-solid flex flex-col gap-4 items-center justify-center p-6 purple_A700_amber_400_border3 sm:px-5 rounded-[20px] w-60">
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            className="leading-[150.00%] max-w-[192px] md:max-w-full text-blue_gray-700_bf text-center text-xs mb-4"
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            “Wow, this was fast! My open rates have never been higher
                                            than this.”
                                        </p>
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            “Finally a Free Email Warm up so I don’t have do it
                                            myself. Thank you.”
                                        </p>
                                        <div className="flex flex-row items-start justify-start w-auto">
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            " Unlike other email warm-up, this warms in the background
                                            so your e doesn’t end up get flooded over night."
                                        </p>
                                        <div className="flex flex-row items-start justify-start w-auto">
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            “Love how I can add my team & see which email is ready to
                                            send more”
                                        </p>
                                        <div className="flex flex-row items-start justify-start w-auto">
                            ...
                            <div className="border border-solid flex flex-col gap-4 h-[294px] md:h-auto items-center justify-center p-6 purple_A700_amber_400_border7 sm:px-5 rounded-[20px] w-60">
                                <img
                                    loading="lazy"
                                    className="h-[62px] md:h-auto rounded-[50%] w-[62px] mt-4"
                                    src="/images2/emily.png"
                                    alt="ellipseForty"
                                />
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    <div className="flex flex-col items-center justify-start w-auto">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            “Must Have for Agents doing cold-emails. If you’re not
                                            warming, you might as well forget about sending.”
                                        </p>
                                        <div className="flex flex-row items-start justify-start w-auto">
                            ...
                            {testimonials.map((testimonial, index) => (
                                <div
                                    key={index}
                                    className="border border-solid flex flex-col gap-4 h-[294px] md:h-auto items-center justify-center p-6 purple_A700_amber_400_border7 sm:px-5 rounded-[20px] w-60"
                                >
                                    <img
                                        loading="lazy"
                                        className="h-[62px] md:h-auto rounded-[50%] w-[62px] mt-4"
...
export default LandingPagev2_EmailWarmup;
