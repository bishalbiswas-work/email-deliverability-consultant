...
const LandingPagev2_EmailWarmup_Consultant = () => {
              ...
              Login
                ...
                <div className="flex flex-col items-start justify-start w-auto md:w-full overflow-hidden">
                    ...
                    Email Warm-up
                                ...
                                >
                                    <>
                                        Complimentary 15-Minute Consultation to Increase Your Sales and Prevent Spam.
                  ...
                  ></input> */}
                                    <button
                                        ...
                                        color="purple_A700_amber_400"
                                        onClick={() => {
                                            window.open('https://calendly.com/daniyal-dehleh/meeting', '_blank');
                                        }}
                    ...
                    <div className="text-center w-full my-12">
                        <div className="py-4">
                            <p
                                className="sm:text-4xl md:text-[38px] text-[32px] text-blue_gray-800 w-full mb-4"
                                size="txtDMSerifDisplayRegular40"
                            >
                                <span className="text-blue_gray-800 font-dmserifdisplay text-left font-normal">

                                    Overview of Email Deliverability Consultant{" "}
            ...
            <div className="relative w-[51%] md:w-full">
              ...
              />
                  ...
                  + Your Analytical Dashboard.
                            ...
                            <div className="flex flex-col items-center justify-start w-auto">
                                ...
                                <div className="flex flex-col font-lato gap-[15.4px] items-start justify-start pb-[0.6px] w-[300px]">
                                    ...
                                    <p
                                        ...
                                        size="txtLatoRegular16Gray60002"
                                    >
                                        We will conduct a comprehensive evaluation of your email reputation.
                                ...
                                <div className="flex flex-col items-center justify-start ml-auto my-auto relative w-auto">
                                    ...
                                    <div className="flex flex-col font-lato gap-[15.4px] items-start justify-start pb-[0.6px] w-[300px]">
                                        <p
                                            ...
                                            size="txtLatoBold20"
                                        >
                                            Observe Enhanced Deliverability
                                        ...
                                        <p
                                            ...
                                            size="txtLatoRegular16Gray60002"
                                        >
                                            Our experts will work to boost and sustain your deliverability score.
                            ...
                            <div className="border border-solid flex flex-col gap-4 items-center justify-center p-6 purple_A700_amber_400_border3 sm:px-5 rounded-[20px] w-60">
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        ...
                                        >
                                            "Amazing and effective! My open rates have reached new heights."
                                        </p>
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            "At last, an automated email warm-up tool that saves me endless hours of manual effort. Thanks!"
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            "This solution works in the background, keeping my inbox organized."
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            "I appreciate being able to add team members and monitor the readiness of every email."
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center w-full">
                                    ...
                                    <div className="flex flex-col gap-8 items-center justify-center w-full">
                                        <p
                                            ...
                                            size="txtLatoRegular12Bluegray700bf"
                                        >
                                            "Essential for agents involved in cold emailing. If you're not warming up your emails, you're missing out."
                                        </p>
                                        <div className="flex flex-row items-start justify-start w-auto">
                                            {/* <RatingBar
                                                className="flex justify-between w-[122px]"
                    ...
                    <div className="bg-white-A700 flex flex-col font-lato h-[209px] md:h-auto items-center justify-center max-w-[1440px] md:px-10 sm:px-5 px-[140px] py-[60px] w-full">
                                        ...
                                        <div className="flex flex-col font-lato gap-4 items-start justify-start w-auto">
                                            ...
                                            <div className="ml-7">
                                                <a
                                                    ...
                                                    className="text-blue_gray-500 text-center text-sm w-auto "
                                                >
                                                    <p size="txtLatoRegular14Bluegray500">Email Deliverability Consultant
...
export default LandingPagev2_EmailWarmup_Consultant;
