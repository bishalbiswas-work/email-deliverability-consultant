...
const PrivacyPolicy = () => {
    return (
        <div className="mx-6 my-8">
            <h4>
                Auto Monitor ("we","our",or "us") is committed to protecting your
                privacy. This Privacy Policy explains how your personal information is
                collected, used, and disclosed by Auto Monitor. This Privacy Policy
                applies to our website, and its associated subdomains (collectively, our
                "Service"). By accessing or using our Service, you signify that you have
            ...
            <h4>
                Please be advised that Auto Monitor explicitly reserves the right to
                offer no refunds once a user exceeds their credit limit. Upon surpassing
                this limit, Auto Monitor incurs irreversible charges from our providers,
                making it impossible to reverse any transactions. As a result, at
                anytime users are able to simply cancel their free trial or future
                charges via the application interface or by contacting our customer
                support team. A usage of timed break gets counted as one credit.
            </h4>
            <br />
            ...
            <h4>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        it refers to Auto Monitor, that is responsible for your information
                        under this Privacy Policy.
                    </li>
                    <li>
                        Country: where Auto Monitor or the owners/founders of Auto Monitor
                        are based, in this case is Canada.
                    </li>
                    <li>
                        Customer: refers to the company, organization or person that signs
                        up to use the Auto Monitor Service to manage the relationships with
                        your consumers or service users.
                    </li>
                    <li>
                        Device: any internet connected device such as a phone, tablet,
                        computer or any other device that can be used visit Auto Monitor and
                        use the services.
                    </li>
                    <li>
                    ...
                    <li>
                        Personnel: refers to those individuals who are employed by Auto
                        Monitor or are under contract to perform a service on behalf of one
                        of the parties.
                    </li>
                    <li>
                    ...
                    <li>
                        Service: refers to the service provided by Auto Monitor as described
                    ...
                    <li>
                        Website: Auto Monitor's site, which can be accessed via this URL:
                        www.AutoMonitor.com
                    </li>
                    <li>
                        You: a person or entity that is registered with Auto Monitor to use
                        the Services.
                    </li>
                </ul>
            </h4>
            ...
            <h3>
                When does Auto Monitor use end user information from third parties?
            </h3>
            <br />
            <h4>
                Auto Monitor will collect End User Data necessary to provide the Auto
                Monitor services to our customers. End users may voluntarily provide us
                with information they have made available on other websites. If you
                provide us with any such information, we may collect publicly available
                information from the websites you have indicated. You can control how
                much of your information these websites make public by visiting these
                websites and changing your privacy settings.
            </h4>
            <br />

            <h3>
                When does Auto Monitor use customer information from third parties?
            </h3>
            <br />
            <h4>
                ...
                becoming an Auto Monitor customer, we receive information from a third
                party that provides automated fraud detection services to Auto Monitor.
                We also occasionally collect information that is made publicly available
                on other websites. You can control how much of your information these
            ...
            <br />
            <h4>
                Auto Monitor will collect personal information that you submit to us. We
            ...
            <h4>
                ...
                customer audience targeting on sites where we display custom advertising
                to specific people who have opted-in to receive communications from us.
                Email addresses submitted only through the order processing page will be
                used for the sole purpose of sending you information and updates
                pertaining to your order. If, however, you have provided the same email
                to us through another method, we may use it for any of the purposes
            ...
            <br />
            <h4>
                We keep your information only so long as we need it to provide Auto
                Monitor to you and fulfill the purposes described in this policy. This
            ...
            <h4>
                ...
                any information you transmit to Auto Monitor or guarantee that your
            ...
            <br />
            <h4>
                Auto Monitor is incorporated in Canada. Information collected via our
            ...
            <br />
            <h3>
                Is the information collected through the Auto Monitor Service secure?
            </h3>
            <br />
            <h4>
            ...
            <h4>
                ...
                Auto Monitor collects depend on your relationship with Auto Monitor.
                ...
                need to back up our systems and protect information from inadvertent
            ...
            <h4>
                ...
                the assets of Auto Monitor or any of its Corporate Affiliates (as
                defined herein), or that portion of Auto Monitor or any of its Corporate
            ...
            <h4>
                ...
                Auto Monitor, whether by ownership or otherwise. Any information
            ...
            <h4>
                ...
                under Privacy Shield, or the Swiss-US framework. The laws of Canada,
                ...
                other local, state, national, or international laws. By using Auto
                Monitor or contacting us directly, you signify your acceptance of this
            ...
            <h4>
                ...
                being used. By using our Auto Monitor, registering an account, or making
            ...
            <h4>
                ...
                contain links to other websites not operated or controlled by Auto
                Monitor. We are not responsible for the content, accuracy or opinions
            ...
            <br />
            <h4>
                Auto Monitor uses "Cookies" to identify the areas of our website that
            ...
            <h4>
                ...
                acknowledge and agree that Auto Monitor shall not be responsible for any
                ...
                or any other aspect thereof. Auto Monitor does not assume and shall not
            ...
            <h4>
                <ul>
                    <li>
                        ...
                        these cookies, certain functionality may become unavailable or you
                    ...
                    <li>
                        Sessions: We use "Sessions" to identify the areas of our website
            ...
            <h4>
                ...
                At Auto Monitor we strongly believe that your data privacy is very
            ...
            <h4>
                ...
                requirements of GDPR. Auto Monitor processes or stores all personal data
                in fully vetted, DPA compliant vendors. We do store all conversation and
                personal data for up to 8 years unless your account is deleted. In which
                case, we dispose of all data in accordance with our Terms of Service and
                Privacy Policy, but we will not hold it longer than 80 days. We are
            ...
            <h4>
                ...
                <ul>
                    <li>Via Email: hello@automonitor.com</li>
                    <li>Via this Link: www.automonitor.com/feedback</li>
                </ul>
            </h4>
            <br />
        </div>
