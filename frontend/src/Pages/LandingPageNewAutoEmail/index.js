...
const testimonials = [
  {
    ...
    stars: 4,
    imageUrl: "images2/Guillermo.png",
  },
  {
    name: "Jasmin Hen",
    title: "Founder @Zown",
  ...
  },
  {
    ...
    stars: 4,
    imageUrl: "images2/MaralZadeh-modified.png",
  },
];
...
export default function LandingPageNewAutoEmail() {
      ...
      <header className="bg-white-A700  p-2 md:px-5 rounded-[20px] shadow-bs1 w-full">
        <nav className="bg-gradient-to-r from-white to-purple-100 p-4 flex justify-between items-center">
          ...
          <div className="flex md:hidden space-x-4">
            ...
            <a href="https://emailwarmup.com" className="text-orange-600">
              Email Warmup
            </a>
