...
const AutoEmail_Warmup_LandingPage = () => {
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>Free Email Warmup | 100% Inbox Guaranteed</title>
      </Helmet>
                  ...
                  <div className="flex flex-col space-y-4">
                    <div className="rounded flex flex-col items-center justify-center">
                      ...
                      <h2 className="leading-[170.00%] text-base text-blue_gray-800_bf text-center mt-8">
                        <>
                          Boost Your Sales, Avoid Spam with Free Email Warm Up.
            ...
            <div className="flex flex-1 flex-col items-start justify-start w-full">
              <div className="flex flex-col gap-3 items-left justify-center w-full">
                ...
                <Text
                  ...
                  size="txtLatoRegular16"
                >
                  Heats up faster than your coffee!
            ...
            <div className="flex flex-1 flex-col items-start justify-start w-full">
              <div className="flex flex-col gap-3 items-start justify-center w-full">
                ...
                <Text
                  ...
                  size="txtLatoRegular16"
                >
                  Add or Remove members effortlessly.
                </Text>
              </div>
            </div>
              ...
              <div className="border border-solid flex flex-col gap-4 items-center justify-center p-6 purple_A700_amber_400_border3 sm:px-5 rounded-[20px] w-60">
                ...
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <div className="flex flex-col gap-8 items-center justify-center w-full">
                    ...
                    >
                      "This was incredibly quick and effective. My open rates have never been higher."
                ...
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <div className="flex flex-col gap-8 items-center justify-center w-full">
                    <Text
                      ...
                      size="txtLatoRegular12Bluegray700bf"
                    >
                      "Finally, an email warm-up solution that spares me from spending hours doing it manually. Thank you."
                    </Text>
                    <div className="flex flex-row items-start justify-start w-auto">
                      <RatingBar
                        className="flex justify-between w-[122px]"
                ...
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <div className="flex flex-col gap-8 items-center justify-center w-full">
                    <Text
                      ...
                      size="txtLatoRegular12Bluegray700bf"
                    >
                      "Unlike other tools, this one works quietly in the background, preventing your inbox from becoming overloaded overnight."
                    </Text>
                    <div className="flex flex-row items-start justify-start w-auto">
                      <RatingBar
                        className="flex justify-between w-[122px]"
                ...
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <div className="flex flex-col gap-8 items-center justify-center w-full">
                    <Text
                      ...
                      size="txtLatoRegular12Bluegray700bf"
                    >
                      "I appreciate being able to add team members and monitor when each email is prepared for further action."
                    </Text>
                    <div className="flex flex-row items-start justify-start w-auto">
                      <RatingBar
                        className="flex justify-between w-[122px]"
                ...
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <div className="flex flex-col gap-8 items-center justify-center w-full">
                    <Text
                      ...
                      size="txtLatoRegular12Bluegray700bf"
                    >
                      "Crucial for agents doing cold outreach. Without warming up, your efforts are wasted."
                    </Text>
                    <div className="flex flex-row items-start justify-start w-auto">
                      <RatingBar
                        className="flex justify-between w-[122px]"
...
export default AutoEmail_Warmup_LandingPage;
